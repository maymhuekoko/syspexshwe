@extends('master')
@section('title','Purchase Order Accounting')
@section('link','Purchase Order Accounting')
@section('content')
<h4 class="text-secondary mb-3">Purchase Order Accounting - <span style="font-size:20px">Create Purchase Order Form<span class="text-success">({{$project->name}})</span></span></h4>
<div class="row justify-content-center offset-md-2 mt-2" style="width:700px">
    <div class="card" style="border-radius:25px">
        <div class="card-body">
            <form action="{{route('store_po_accounting')}}" method="post">
                @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control border-info" name="po_no" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Date</label>
                        <input type="date" class="form-control border-info" name="po_date" >
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label>Supplier Name</label>
                <select class="form-control border-info"  name="supplier" data-placeholder=""  style="width: 100%;">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="margin-top:6px">
                    ...
                    <select class="form-control border-info"  name="currency_id" data-placeholder=""  style="width: 100%;">
...
<!-- Begin Paid Modal -->
        <div class="modal fade" id="paid_po" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
