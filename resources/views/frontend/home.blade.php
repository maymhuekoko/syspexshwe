    ...
    <section class="pb-6">
      ...
      <div class="container">
        <div class="row flex-center">
          <div class="col-lg-6 col-md-5 order-md-1"><img class="img-fluid" src="{{asset('frontend/assets/img/illustrations/1.png')}}" alt="" /></div>
    ...
    <section class="pt-4 pt-md-6">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-5 col-lg-7 text-lg-center"><img class="img-fluid mb-5 mb-md-0" src="{{asset('frontend/assets/img/illustrations/2.png')}}" alt="" /></div>
